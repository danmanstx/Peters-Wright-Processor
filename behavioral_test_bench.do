...
add wave -noupdate -format Literal -label {PC input mux inputs} -radix hexadecimal /Processor/PC_MUX_0/in
...
add wave -noupdate -format Literal -label {IR in} /Processor/IR/in
...
add wave -noupdate -format Literal -label {PSR0 in} /Processor/PSR0/in
