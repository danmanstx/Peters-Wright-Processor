...
module RAM_interrupts(addr, ce, clk, clr, rw, data);
    ...
    begin
        ...
        memory[12] = 16'b1010010000000000;
        memory[13] = 16'b0111111100000000;
        memory[14] = 16'b0001000000000000;
        ...
        memory[21] = 16'b1111111111111111;
        ...
        memory[28] = 16'b1000000001110000;
