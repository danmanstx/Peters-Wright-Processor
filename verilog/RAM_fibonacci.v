...
module RAM_fibonacci(addr, ce, clk, clr, rw, data);
    ...
    begin
        ...
        memory[18] = 16'b1001100000000100;
        memory[19] = 16'b0010010000000000;
        memory[20] = 16'b0000000100000000;
        memory[21] = 16'b1001010100000000;
        memory[22] = 16'b0001000001010000;
        memory[23] = 16'b0001010000000000;
        memory[24] = 16'b0000001000000000;
        memory[25] = 16'b1000100000000000;
