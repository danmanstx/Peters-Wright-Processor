...
module RAM_bubblesort(addr, ce, clk, clr, rw, data);
    ...
    begin
        ...
        begin
            data_out_reg <= 0;
            memory[0] <= 16'b1010110000000000;
            memory[1] <= 16'b1010010000000000;
            memory[2] <= 16'b0000010100000000;
            memory[3] <= 16'b1010100000000000;
            memory[4] <= 16'b0000000000000000;
            memory[5] <= 16'b1010010001000000;
            memory[6] <= 16'b0000001100000000;
            memory[7] <= 16'b1010100001000000;
            memory[8] <= 16'b0000000100000000;
            memory[9] <= 16'b1010010010000000;
            memory[10] <= 16'b0000100100000000;
            memory[11] <= 16'b1010100010000000;
            memory[12] <= 16'b0000001000000000;
            memory[13] <= 16'b1010010011000000;
            memory[14] <= 16'b0000000000000000;
            memory[15] <= 16'b1010100011000000;
            memory[16] <= 16'b0000001100000000;
            memory[17] <= 16'b1010010100000000;
            memory[18] <= 16'b0000010000000000;
            memory[19] <= 16'b1010100100000000;
            memory[20] <= 16'b0000010000000000;
            memory[21] <= 16'b1010010101000000;
            memory[22] <= 16'b0000011100000000;
            memory[23] <= 16'b1010100101000000;
            memory[24] <= 16'b0000010100000000;
            memory[25] <= 16'b1010010110000000;
            memory[26] <= 16'b0000000100000000;
            memory[27] <= 16'b1010100110000000;
            memory[28] <= 16'b0000011000000000;
            memory[29] <= 16'b1010010111000000;
            memory[30] <= 16'b0000001000000000;
            memory[31] <= 16'b1010100111000000;
            memory[32] <= 16'b0000011100000000;
            memory[33] <= 16'b1010011000000000;
            memory[34] <= 16'b0000100000000000;
            memory[35] <= 16'b1010101000000000;
            memory[36] <= 16'b0000100000000000;
            memory[37] <= 16'b1010011001000000;
            memory[38] <= 16'b0000011000000000;
            memory[39] <= 16'b1010101001000000;
            memory[40] <= 16'b0000100100000000;
            memory[41] <= 16'b1010011010000000;
            memory[42] <= 16'b0000000000000000;
            memory[43] <= 16'b1001001011101000;
            memory[44] <= 16'b0001111011000000;
            memory[45] <= 16'b0000000100000000;
            memory[46] <= 16'b1001010000101000;
            memory[47] <= 16'b1001010001101100;
            memory[48] <= 16'b1001000010000100;
            memory[49] <= 16'b0010000010000000;
            memory[50] <= 16'b0111100010000010;
            memory[51] <= 16'b1000000011100100;
            memory[52] <= 16'b1001001100000000;
            memory[53] <= 16'b1001000000000100;
            memory[54] <= 16'b1001000001110000;
            memory[55] <= 16'b1001101010000000;
            memory[56] <= 16'b1001101011000100;
            memory[57] <= 16'b0001111011000000;
            memory[58] <= 16'b0000000100000000;
            memory[59] <= 16'b1001001101101100;
            memory[60] <= 16'b0010111101000000;
            memory[61] <= 16'b0000101000000000;
            memory[62] <= 16'b0111101101110000;
            memory[63] <= 16'b0001111010000000;
            memory[64] <= 16'b0000000100000000;
            memory[65] <= 16'b1001001101101000;
            memory[66] <= 16'b0010111101000000;
            memory[67] <= 16'b0000101000000000;
            memory[68] <= 16'b0111101101100111;
